...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:root@127.0.0.1:3306/aula'
...
def seleciona_usuarios():
    ...
    print(usuarios_json)
    return gera_response(200, "usuarios", usuarios_json, "ok ael")
...
def seleciona_usuario(id):
    ...
    return gera_response(200, "usuario", usuario_json, "ok ael ****")
...
def cria_usuario():
    ...
    try:
        ...
        print(e)
        return gera_response(400, "usuario", {}, "Erro ao criar")
...
def gera_response(status, nome_do_contend, conteudo, mensagem=False):
  body = {}
  body[nome_do_contend] = conteudo
